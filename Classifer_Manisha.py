...
def all_classifiers(X_train[h], X_val[h], y_G1[h], split_index_train, split_index_val, "G1", n_neighbors, kernel_SVM, val_test, h):
    metrics_list = []
    ...
    #KNeighbours Model
    Kneigh = KNeighborsClassifier(n_neighbors)
...
for h in range(len(y_G1)):
    ...
    all_classifiers(X_train[h], X_val[h], y_G1[h], split_index_train, split_index_val, "G1", n_neighbors, kernel_SVM, val_test, h)
    all_classifiers(X_train[h], X_val[h], y_G2[h], split_index_train, split_index_val, "G2", n_neighbors, kernel_SVM, val_test, h)
    all_classifiers(X_train[h], X_val[h], y_G3[h], split_index_train, split_index_val, "G3", n_neighbors, kernel_SVM, val_test, h)


    val_test = 'TEST'
    
    all_classifiers(X_train[h], X_test[h], y_G1[h], split_index_train, split_index_val, "G1", n_neighbors, kernel_SVM, val_test, h)
    all_classifiers(X_train[h], X_test[h], y_G2[h], split_index_train, split_index_val, "G2", n_neighbors, kernel_SVM, val_test, h)
    all_classifiers(X_train[h], X_test[h], y_G3[h], split_index_train, split_index_val, "G3", n_neighbors, kernel_SVM, val_test, h)
